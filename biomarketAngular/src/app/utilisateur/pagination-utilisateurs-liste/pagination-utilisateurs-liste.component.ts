...
@Component({
  selector: 'app-pagination-utilisateurs-liste',
  templateUrl: './pagination-utilisateurs-liste.component.html',
  styleUrls: ['./pagination-utilisateurs-liste.component.scss']
})
export class PaginationUtilisateursListeComponent implements OnInit {
