...
--
-- Hôte : localhost:8889
-- Généré le : mer. 16 mars 2022 à 20:24
...
--
-- Base de données : `java_biomarket`
--
...
(4, 'Gérard', 'Shell', '69000', '12 rue delacourt', 'Lyon', 'gerardshelllll@outlook.fr', '0729301657', 'Particulier');
...
CREATE TABLE `commande` (
  ...
  `fournisseur_fournisseur_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `commande` (`commande_id`, `date`, `utilisateur_utilisateur_id`, `fournisseur_fournisseur_id`) VALUES
(1, '2022-03-17', 1, 1),
(2, '2022-03-31', 4, 3);
...
INSERT INTO `utilisateur` (`utilisateur_id`, `login`, `mdp`, `nom`, `prenom`, `telephone`, `role_role_id`) VALUES
...
INSERT INTO `vente` (`vente_id`, `date`, `statut`, `utilisateur_utilisateur_id`, `client_client_id`) VALUES
(1, '2022-04-02', 'Payée', 2, 1),
(2, '2022-04-13', 'Payée', 3, 3),
(3, '2022-04-30', 'Non payée', 2, 2),
(4, '2022-11-28', 'Payé', 1, 1);
...
ALTER TABLE `commande`
  ...
  ADD KEY `utilisateur_id` (`utilisateur_utilisateur_id`),
  ADD KEY `fournisseur_id` (`fournisseur_fournisseur_id`);
...
ALTER TABLE `vente`
  ...
  ADD KEY `utilisateur_id` (`utilisateur_utilisateur_id`),
  ADD KEY `client_id` (`client_client_id`),
  ADD KEY `utilisateur_id_2` (`utilisateur_utilisateur_id`);
...
--
ALTER TABLE `vente`
  MODIFY `vente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`utilisateur_utilisateur_id`) REFERENCES `utilisateur` (`utilisateur_id`),
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`fournisseur_fournisseur_id`) REFERENCES `fournisseur` (`fournisseur_id`);
...
--
ALTER TABLE `utilisateur`
  ADD CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`role_role_id`) REFERENCES `role` (`role_id`);

--
-- Contraintes pour la table `vente`
--
ALTER TABLE `vente`
  ADD CONSTRAINT `vente_ibfk_1` FOREIGN KEY (`client_client_id`) REFERENCES `client` (`client_id`),
  ADD CONSTRAINT `vente_ibfk_2` FOREIGN KEY (`utilisateur_utilisateur_id`) REFERENCES `utilisateur` (`utilisateur_id`);
COMMIT;
